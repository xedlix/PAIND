...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lowPassTaps = lowPassTaps = firdes.low_pass(1.0, samp_rate, 130e3, 2e3, firdes.WIN_HAMMING, 6.76)
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(8, (lowPassTaps))
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\yanni\\OneDrive\\Documents\\Hochschule\\5.Semester\\PAIND\\SDR\\FFT2\\document01.sig', True)
        ...
        self.connect((self.limesdr_source_0, 0), (self.fir_filter_xxx_0, 0))
